...
nohup sh getSummaryCorrConsist.sh "Release 2017_09 (UP)" 2017_09 ../results_corr_consist > ../results_corr_consist/summary.html
...
perl getRPChange.pl ../../proteomePIRScores_2017_08_PPS/results_corr_consist/rpg-55bac_arch-75euk-ASMean.txt ../results_corr_consist/rpg-55bac_arch-75euk-ASMean.txt > ../logs/RPChange.log
...
perl getCPPair.pl ../../proteomePIRScores_2017_08_PPS/results_corr_consist/75/rpg-75.txt ../results_corr_consist/75/rpg-75.txt ../data/replacedTaxonId.txt  | sort > ../results_corr_consist/RP75_CP_diff.txt
