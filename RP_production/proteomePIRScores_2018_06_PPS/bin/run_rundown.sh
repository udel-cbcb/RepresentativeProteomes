...
nohup sh getSummaryCorrConsist_rundown.sh "Release 2016_11" 2016_11 ../results_corr_consist > ../results_corr_consist_rundown/summary.html
...
# create RP75 CP diff file, "2016_10" is previous release
perl getCPPair_rundown.pl /data/chenc/2016/proteomePIRScores_2016_10_PPS/results_corr_consist_rundown/75/rpg-75.txt ../results_corr_consist_rundown/75/rpg-75.txt ../data/replacedTaxonId.txt  | sort > ../results_corr_consist_rundown/RP75_CP_diff.txt


# Copy results to  /huge/chenc/2016/pirRPs/proteomePIRScores_2016_11_UP, then notify Raja to create RG file,
#scp -rp ../results_corr_consist_rundown /huge/chenc/2016/pirRPs/proteomePIRScores_2016_11_UP
