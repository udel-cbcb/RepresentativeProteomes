...
my $usedEntryFile = "../data/score/proteome_entries.txt";
my %usedEntries = ();
...
#
my $proteomeScoreFile = "../data/score/proteomeScores.txt";
...
my $proteomeASScoreFile = "../data/score/proteomeASScores.txt";
...
for my $upIdAndTaxId (keys %proteomeASInfo) {
	...
	my $normPMID = 1000*(1+(($pmidCount - $proteomePMIDCountMin)/$rangeProteomePMIDCount));
	 print "PMID: |".$normPMID."|".$pmidCount."|".$proteomePMIDCountMin."|".$rangeProteomePMIDCount."\n";
	my $normASMean = 100*(1+(($ASMean - $proteomeASMeanMin)/$rangeProteomeASMean));
	 print "ASMean: |".$normASMean."|".$ASMean."|".$proteomeASMeanMin."|".$rangeProteomeASMean."\n";
