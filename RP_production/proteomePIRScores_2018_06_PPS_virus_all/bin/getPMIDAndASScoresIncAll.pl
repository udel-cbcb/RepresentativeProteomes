...
my $usedEntryFile = "../data/score_inc_all/proteome_entries.txt";
my %usedEntries = ();
...
my $scoreDir = "../data/score_inc_all";
...
#
my $proteomeScoreFile = "../data/score_inc_all/proteomeScores.txt";
...
my $proteomeASScoreFile = "../data/score_inc_all/proteomeASScores.txt";
