...
perl getRPSeqByAC_uniprot.pl ../results_corr_consist/$cutoff/rp-seqs-$cutoff.txt > ../results_corr_consist/$cutoff/rp-seqs-$cutoff.fasta
perl getRPSeqByAC_uniprot.pl ../results_corr_consist/$cutoff/non-rp-seqs-$cutoff.txt > ../results_corr_consist/$cutoff/non-rp-seqs-$cutoff.fasta
